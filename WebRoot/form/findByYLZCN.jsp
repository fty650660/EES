...
<html:html lang="true">
    <head>
        <html:base/><title>按优良中差和未评价课程查看所有课程</title>
...
//							{ display: '教师号', name: 'TID', width: 50,align:'center' },  
							{ display: '教师', name: 'TNAME', width: 50,align:'center' ,render: function (row)
                                {								
...
//	                                    var html = '<p>无评价</p>';
                            ...
                            ], data: <%=request.getAttribute("allTeaString")%>, pageSize: 20, sortName: 'CustomerID',
