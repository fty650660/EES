...
//            	history.go(-2);
						var url="<%=request.getContextPath()%>/TeaEvaluation.do?method=showFacultyCourse";
		       ...
		       <div style="witth:100%" align="middle">
				...
				<table width="90%" style="border-collapse:collapse" class="l-table-edit">
					<tr>
						...
						<td width="28%"><input type="text" name="subtime" class="l-table-edit-td" validate="{required:true}" value=${teaEvaluationForm.subtime}></td>
					</tr>
				</table>
				</div>
				<br>
				...
				<div id="submitbutton" style="width:50%;float:left">
	            	<input type="submit" value="打印" class="l-button l-button-submit">
				</div>
				<div id="printbutton" style="width:50%;float:right">				
					<input type="button" value="返回" class="l-button l-button-test">
				</div>				
			</div> 
			<!--
			<div id="container" align="middle" style="width:85%">
