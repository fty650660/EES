        ...
        <form action="<%= request.getContextPath()%>/Mail.do?method=writeMailAction" method="post">
            ...
            <table cellpadding="0" cellspacing="0" class="l-table-edit">
                ...
                <tr>
                    ...
                    <td align="left" class="l-table-edit-td">
                        <input name="theme" type="text" id="theme" ltype="text" validate="{required:true}"/>
                    </td>
                    <td align="left">
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="left" class="l-table-edit-td">
                        <textarea name="details" cols="100" rows="4" class="l-textarea" style="width:90%" validate="{required:true}">
                        </textarea>
                    </td>
                    <td align="left">
                    </td>
